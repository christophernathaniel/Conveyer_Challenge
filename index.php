...
echo formatAnswer(
    init(
        [
            'items' => 200, // Items can either be a number, or a specified group of items
            'workerCount' => 6, // Worker Count
            'beltLengthCount' => 3, // Conveyer Belt Length
            'put_on_conveyer' => ['a', 'b', 'c', '0'], // The random items to be put on the conveyer
            'define_blank_space' => '0',
            'settings' => (object) [ // Worker Settings
                'arms' => [false, false, false],
                'names' => ['Bob', 'Joe', 'Murph', 'Jason', 'Mike', 'Larry'],
                'collectable_items' => ['a', 'b', 'c'], // What the worker wants to pick up
                'items_to_process' => ['a', 'b', 'c'], // What the worker needs to process an item
                ...
                'define_blank_space' => '0' // Define what a worker thinks is a blank space
            ]
        ]
    )
);
